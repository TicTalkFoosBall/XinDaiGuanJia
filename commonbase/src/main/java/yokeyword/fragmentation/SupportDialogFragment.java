 ...
 */
public class SupportDialogFragment extends RxDialogFragment implements ISupportFragment {
     ...
     * 加载多个同级根Fragment,类似Wechat, QQ主页的场景
     */
    public void loadMultipleRootFragment(int containerId, int showPosition, String[] tags, ISupportFragment... toFragments) {
        mDelegate.loadMultipleRootFragment(containerId, showPosition, tags, toFragments);
    }
