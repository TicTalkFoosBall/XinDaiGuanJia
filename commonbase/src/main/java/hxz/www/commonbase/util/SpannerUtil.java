...
public final class SpannerUtil {
     ...
     *             </ul>
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setBullet(@ColorInt final int color,
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setFontProportion(final float proportion) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setFontXProportion(final float proportion) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setStrikethrough() {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setUnderline() {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setSuperscript() {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setSubscript() {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final Blur style) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                   final float dx,
                                   final float dy,
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil append(@NonNull final CharSequence text) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendImage(@DrawableRes final int resourceId, @Align final int align) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpannerUtil}
     */
    public SpannerUtil appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                Bitmap bitmap;
                try {
                    InputStream is = BaseApplication.getInstance().getContentResolver().openInputStream(mContentUri);
