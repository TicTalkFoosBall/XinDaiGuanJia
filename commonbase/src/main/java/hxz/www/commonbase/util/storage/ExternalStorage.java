...
public class ExternalStorage {
    ...
    void init(Context context, StorageLocation location) {
        this.context = context;

        if (location == StorageLocation.TYPE_PRIVATE) {
            storageRoot = PRIVATE_ROOT;
        } else if (location == StorageLocation.TYPE_PUBLIC_COMMON) {
            storageRoot = PUBLIC_COMMON_ROOT;
        } else {
            storageRoot = PUBLIC_PRIVATE_ROOT;
        }
