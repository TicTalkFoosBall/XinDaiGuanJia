...
public class RoundViewDelegate {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        backgroundColor = ta.getColor(R.styleable.RoundTextView_rv_backColor, Color.TRANSPARENT);
        backgroundPressColor = ta.getColor(R.styleable.RoundTextView_rv_backPressColor, Integer.MAX_VALUE);
    ...
    public void setBackPressColor(int backgroundPressColor) {
