...
//            tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
            ...
            if (mIconVisible) {
                ...
                iv_tab_icon.setScaleType(ImageView.ScaleType.CENTER_CROP);
            } else {
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            Drawable drawable = ContextCompat.getDrawable(getContext(), isSelect ? tabEntity.getTabSelectedIcon() : tabEntity.getTabUnselectedIcon());
