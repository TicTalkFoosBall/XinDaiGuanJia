...
public class MultiStateView extends FrameLayout {
    ...
    public void showNetError(OnClickListener clickListener) {
        ...
        mErrorView.findViewById(R.id.tv_retry).setOnClickListener(clickListener);
        ((TextView) mErrorView.findViewById(R.id.tv_retry)).setText("刷新");
        ((TextView) mErrorView.findViewById(R.id.tv_error_message)).setText("网络好像出问题了喔～");
        ((ImageView) mErrorView.findViewById(R.id.iv_error)).setImageResource(R.mipmap.empty_network_error);
    }



    /**
     * Sets the current {@link view.state.MultiStateView.ViewState}
     *
     * @param state The {@link view.state.MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link view.state.MultiStateView.ViewState}
     */
     ...
     * @param state         The {@link view.state.MultiStateView.ViewState}to set
     * @param switchToState If the {@link view.state.MultiStateView.ViewState} should be switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link view.state.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link view.state.MultiStateView.ViewState} to set
     */
