package hxz.www.commonbase.state;
...
public class MultiStateView extends FrameLayout {
    ...
    /**
     * Returns the {@link View} associated with the {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}
     *
     * @param state The {@link com.xingxiu.frame.view.state.MultiStateView.ViewState} with to return the view for
     * @return The {@link View} associated with the {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}, null if no view is present
     */
    @Nullable
    ...
    /**
     * Returns the current {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}
     *
     * @return
     */
    @ViewState
    ...
    public void showNetError(OnClickListener clickListener) {
        setVisibility(View.VISIBLE);
        setViewState(VIEW_STATE_ERROR);
        mErrorView.findViewById(com.xingxiu.frame.R.id.tv_retry).setOnClickListener(clickListener);
        ((TextView) mErrorView.findViewById(com.xingxiu.frame.R.id.tv_retry)).setText("刷新");
        ((TextView) mErrorView.findViewById(com.xingxiu.frame.R.id.tv_error_message)).setText("网络好像出问题了喔～");
        ((ImageView) mErrorView.findViewById(com.xingxiu.frame.R.id.iv_error)).setImageResource(R.mipmap.empty_network_error);
    }

    public void showLocationError(OnClickListener clickListener) {
        setVisibility(View.VISIBLE);
        setViewState(VIEW_STATE_ERROR);
        mErrorView.findViewById(com.xingxiu.frame.R.id.tv_retry).setOnClickListener(clickListener);
        ((TextView) mErrorView.findViewById(com.xingxiu.frame.R.id.tv_retry)).setText("开启定位");
        ((TextView) mErrorView.findViewById(com.xingxiu.frame.R.id.tv_error_message)).setText("还未开启定位～");
        ((ImageView) mErrorView.findViewById(com.xingxiu.frame.R.id.iv_error)).setImageResource(R.mipmap.empty_location_unopen);
    }

    /**
     * Sets the current {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}
     *
     * @param state The {@link com.xingxiu.frame.view.state.MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}
     */
     ...
     * @param state         The {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}to set
     * @param switchToState If the {@link com.xingxiu.frame.view.state.MultiStateView.ViewState} should be switched to
     */
    ...
    /**
     * Sets the {@link View} for the given {@link com.xingxiu.frame.view.state.MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {@link com.xingxiu.frame.view.state.MultiStateView.ViewState} to set
     */
