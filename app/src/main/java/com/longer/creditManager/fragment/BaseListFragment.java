...
import hxz.www.commonbase.uibase.BaseFragment;
 ...
 */
public abstract class BaseListFragment<T extends BasePresenterImpl, A extends BaseAdapter> extends BaseFragment<T> {
