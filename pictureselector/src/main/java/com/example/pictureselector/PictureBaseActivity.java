...
import com.example.pictureselector.compress.Luban;
import com.example.pictureselector.compress.OnCompressListener;
...
import com.example.pictureselector.dialog.PictureDialog;
...
import com.example.pictureselector.immersive.ImmersiveManage;
import com.example.pictureselector.rxbus2.RxBus;
import com.example.pictureselector.tools.AttrsUtils;
...
public class PictureBaseActivity extends FragmentActivity {
            ...
            Luban.with(this)
                    ...
                    .setCompressListener(new OnCompressListener() {
                        ...
                        public void onSuccess(List<LocalMedia> list) {
                            Log.i("PictureBaseActivity", "compressImage sucess:");
    ...
    private void handleCompressCallBack(List<LocalMedia> images, List<File> files) {
        Log.i("PictureBaseActivity", "handleCompressCallBack sucess:"+files.size()+":::"+images.size());
        if (files.size() == images.size()) {
            for (int i = 0, j = images.size(); i < j; i++) {
                ...
                Log.i("PictureBaseActivity", "handleCompressCallBack sucess:"+path);
            }
        }
        RxBus.getDefault().post(new EventEntity(PictureConfig.CLOSE_PREVIEW_FLAG));
        onResult(images);
    ...
    protected void handlerResult(List<LocalMedia> result) {
        Log.i("PictureBaseActivity", "handlerResult:"+config.isCompress);
    ...
    protected void onResult(List<LocalMedia> images) {
        Log.i("PictureBaseActivity", "onResult:"+images.size());
        dismissCompressDialog();
        if (config.camera
    ...
    protected void closeActivity() {
        Log.i("PictureBaseActivity", "closeActivity:");
        finish();
        if (config.camera) {
