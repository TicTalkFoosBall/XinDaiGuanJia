...
import com.example.pictureselector.photoview.OnViewTapListener;
import com.example.pictureselector.photoview.PhotoView;
...
import com.example.pictureselector.widget.longimage.ImageSource;
import com.example.pictureselector.widget.longimage.ImageViewState;
...
public class  PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    private void showDownLoadDialog(final String path) {
        final CustomDialog dialog = new CustomDialog(PictureExternalPreviewActivity.this,
                PickScreenUtils.getScreenWidth(PictureExternalPreviewActivity.this) * 3 / 4,
                PickScreenUtils.getScreenHeight(PictureExternalPreviewActivity.this) / 4,
