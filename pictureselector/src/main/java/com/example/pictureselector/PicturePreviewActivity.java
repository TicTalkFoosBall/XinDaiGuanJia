...
import com.example.pictureselector.adapter.SimpleFragmentAdapter;
...
import com.example.pictureselector.widget.PreviewViewPager;
...
public class PicturePreviewActivity extends PictureBaseActivity implements
    ...
    public void eventBus(EventEntity obj) {
        Log.i("PicturePreviewActivity", "eventBus");
        switch (obj.what) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.i("PicturePreviewActivity", "onCreate");
        setContentView(R.layout.picture_preview);
        if (!RxBus.getDefault().isRegistered(this)) {
            RxBus.getDefault().register(this);
        }
        mHandler = new Handler();
        screenWidth = PickScreenUtils.getScreenWidth(this);
    ...
    private void singleRadioMediaImage() {
        Log.i("PicturePreviewActivity", "singleRadioMediaImage");
    ...
    public void onResult(List<LocalMedia> images) {
        Log.i("PicturePreviewActivity:", "onResult");
