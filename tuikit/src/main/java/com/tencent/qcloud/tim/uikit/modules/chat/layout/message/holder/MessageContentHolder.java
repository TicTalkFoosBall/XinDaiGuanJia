...
public abstract class MessageContentHolder extends MessageEmptyHolder {
    ...
    public TextView usernameText,isread;
    public LinearLayout msgContentLinear;
    public ProgressBar sendingProgress;
    public ImageView statusImage;
    public TIMMessage message1;
    ...
    public void layoutViews(final MessageInfo msg, final int position) {
        ...
        if (msg.isSelf()) {
            ...
            TIMConversationType a = TIMConversationType.C2C;
            isread.setVisibility(View.VISIBLE);
//            if (TIMConversationType.C2C ==  a){
//                isread.setVisibility(View.VISIBLE);
//
//            }else {
...
//            notifyAll();
            ...
            isread.setVisibility(View.VISIBLE);
            message1 = new TIMMessage();
            boolean peerReaded = message1.isPeerReaded();
            boolean read = message1.isRead();
            if (peerReaded){
